...
if(!isset($_SESSION["login"])){
  ...
  $query_res_test = "SELECT * FROM result_test WHERE nim='$name'";
  $temp = fetch_table($query_res_test);
    ...
    <div class="row no-gutters mt-5" style="overflow-x: hidden;">
      ...
      <div class="col-md-9" style="overflow-x: auto;">
        ...
        <div class="row ml-auto">
          ...
          <table class="table table-striped ml-5" style="width: 1000px">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><textarea class="form-control" style=" height: 300px; "><?php echo base64_decode($key["answear"]) ?></textarea></td>
