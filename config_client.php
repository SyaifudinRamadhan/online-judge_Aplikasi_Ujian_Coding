  ...
  <body>
    ...
    <div class="row no-gutters mt-5" style="overflow-x: hidden;">
      ...
      <div class="col-md-10" style="overflow-x: auto;">
        <h3 class="m-5"><i class="fas fa-user-alt mr-3"></i>Kelola Peserta<hr class="bg-secondary"></hr></h3>
        ...
        <div class="row ml-5 text-white">
           ...
           <div class="card-body text-dark">
                <h5 class="card-title">Halaman Kelola dan Tambah Peserta</h5>
                <p class="card-text">
                	1. Peserta harus memiliki nama nim dan password. <br>
                	2. Untuk input password tidak digunakn type password. Sehingga admin bisa melihatnya secara langsung dan bisa mengeditnya secra langsung pula. <br>
                	3. Untuk mengeditnya akn ditampilkan pop up form edit setelah me klik tombol edit. <br>
        ...
        <div class="row ml-5 mt-5">
			...
			<!-- Modal -->
			<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-res_client[$a]board="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <form action="edit_del_client.php" method="POST">
            ...
            <div class="form-group">
             ...
             <input type="text" name="nim" class="form-control" required="" id="exampleFormControlInput2">
            </div>
            <div class="form-group">
             <label for="exampleFormControlInput3">Password</label>
             <input type="text" name="password" class="form-control" required="" id="exampleFormControlInput3">
            </div>
        ...
        <div class="row ml-5 mt-5 text-white" style="margin-bottom: 200px">
          ...
          <table class="table table-striped " style="width: 1200px">
            ...
            <tbody>
              <?php $i = 1; ?>
              <?php for ($a=0; $a<sizeof($res_client); $a++) :?>
              <tr>
                <script type="text/javascript">
                  function confirm_d(){
                    var konfirm = confirm("Yakin ingin menghapusnya ?");
                    if(konfirm == true){
                       document.location.href = "edit_del_client.php?delete=<?php echo $res_client[$a]['id'] ?>";
                    }
                  }
                </script>
                <th scope="row"><?php echo $i ?></th>
                <td><?php echo $res_client[$a]["nama"] ?></td>
                <td><?php echo $res_client[$a]["nim"] ?></td>
                <td><?php echo $res_client[$a]["password"] ?></td>
                <td>
                  <button class="btn btn-success mr-1" data-toggle = "modal" data-target="#staticBackdropedit<?php echo $res_client[$a]['id'] ?>">Edit</button>
                  <button class="btn btn-danger mr-1" onclick="confirm_d()">Hapus</button>


                  <div class="modal fade" id="staticBackdropedit<?php echo $res_client[$a]['id'] ?>" data-backdrop="static" keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel">Edit Peserta</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <form action="edit_del_client.php" method="POST">
                          <div class="modal-body">
                            ...
                            <input type="hidden" name="id" value="<?php echo $res_client[$a]['id'] ?>">
                            <!-- iout token -->
                        <div class="form-group">
                         <label for="exampleFormControlInput1">Nama</label>
                         <input type="text" name="nama" class="form-control" id="exampleFormControlInput1" value="<?php echo $res_client[$a]['nama'] ?>">
                        </div>
                        <div class="form-group">
                         <label for="exampleFormControlInput2">NIM</label>
                         <input type="text" name="nim" class="form-control" id="exampleFormControlInput2" value="<?php echo $res_client[$a]['nim'] ?>">
                        </div>
                        <div class="form-group">
                         <label for="exampleFormControlInput3">Password</label>
                         <input type="text" name="password" class="form-control" id="exampleFormControlInput3" value="<?php echo $res_client[$a]['password'] ?>">
                        </div>
